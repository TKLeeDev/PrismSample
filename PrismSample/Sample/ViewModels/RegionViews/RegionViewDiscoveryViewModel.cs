...
{
    class RegionViewDiscoveryViewModel : BindableBase
    {
        //DiscoveryMeans no added in bootstrapper, no use object, use only type and display it.

        IRegionManager _regionManager;
        public RegionViewDiscoveryViewModel(RegionManager regionManager)
        {
            TimerFunc();
